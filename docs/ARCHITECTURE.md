...
The trust boundary is explicit: untrusted URLs and page text enter only the nondeterministic evidence block; deterministic storage changes happen after consensus; transfers happen only after finalized pool state and exact-once marking.
