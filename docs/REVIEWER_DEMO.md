...
7. For a positive-weight claim, claim GEN and show the parent receipt plus the correlated triggered child transfer. This path is not currently live-proven in the deployment evidence.
