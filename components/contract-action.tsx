...
export function ContractAction({contract, method, args, value = 0n, label, onComplete, actionKey}: {contract: "rounds" | "pool"; method: string; args: unknown[]; value?: bigint; label: string; onComplete?: () => Promise<void> | void; actionKey?: string}) {
